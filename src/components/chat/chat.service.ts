...
export class ChatService {
  ...
  async processMessage({
    ...
    try {
      ...
      const messages = this.constructMessageHistory(conversation.messages, filteredMessage);
      ...
      await this.updateConversationMetrics(conversationId, aiResponse.usage?.total_tokens || 0);
